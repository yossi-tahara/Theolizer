...
1. アップデート（2017/03/06注記：呼称をアップデートに決めました。）
バージョン番号を変更しない方法です
...
|方式|特徴|
|----|----|
|アップデート|1.変更が手軽です。<br>2.自動生成するソース・コードが増えないためコンパイラへの負荷が軽いです。<br>3.新しいプログラムのデータを古いプログラムで読むためのサポートがありません。|
|バージョン・アップ|1.アップデートよりもできることが多いです。<br>2.新しいプログラムでバージョン番号を指定して古いプログラムの最新アップデート版のデータを出力することができます。<br>3.少し手間がかかります。<br>4.自動生成するソース・コードがバージョン番号を上げる度に増えます。|
...
- **クラス定義、enum定義の変更**<br>
1. クラスのメンバ変数の追加／削除／順序変更に対応しています。<br>
2. enum型のシンボルの追加／削除、および、シンボル名で保存／回復するのでシンボル値も自由に変更できます。<br>
<br>

- **クラスについてバージョン・アップ／ダウン処理を記述可能**<br>
1. クラスをバージョン・アップする際に行いたい処理を記述できます。<br>
例えば、変数にオフセットを追加した時、そのオフセットを加える処理などです。<br>
2. 旧バージョン形式で保存したい場合はバージョン・ダウン処理を定義することもできます。<br>
例えば、オフセットを引く処理などです。<br>
3. クラスは名前対応と順序対応を、enum型はシンボル名保存とシンボル値保存を切り替えることができます。<br>
...
これによりバージョンが上がった時のプログラム開発を大きく低減できます。<br>
