...
更に、新しいプログラムで古いプログラムが読めるデータを保存するためのサポートもあります。<br>

ユーザが定義可能な型であるクラス(class/struct)とenum型の定義を変更するに際して、2種類の変更対応方法を用意しています。

1. <b>アップデート</b><br>
バージョン番号を変更しない方法です。

2. <b>バージョン・アップ</b><br>
バージョン番号を１つ上げて対応する方法です。
...
|バージョン・アップ|1.変更作業は少し手間がかかります。<br>2.旧バージョンの変数リストやシンボル・リストを保持するため、<br>バージョン番号を上げる度に自動生成されるソース・コードが増えます。<br>3.旧バージョン形式のデータを保存することができます。<br>4.アップデートよりもできることが多いです。|

可能な時はアップデートにて変更対応し、それでは不足の場合にバージョン・アップすることがお薦めです。<br>
<br>
下記のような特徴があります。

1. **クラス定義、enum定義の変更**<br>
  - クラスのメンバ変数の追加／削除／順序変更に対応しています。<br>
  - enum型のシンボルの追加／削除、および、シンボル名で保存／回復するのでシンボル値も自由に変更できます。<br>
<br>

2. **クラスについてバージョン・アップ／ダウン処理を記述できます**<br>
...
3. **バージョン・アップ／ダウンをカスケードに処理します**<br>
...
バージョン・アップする時はenum値や変数の追加を行うケースが多いですが、古い形式のデータを保存した場合、その追加されたデータを削除しています。（古いバージョンのプログラムはそのデータの存在を知らないため、もしも残すと古いプログラムが処理できなくなるためです。）
