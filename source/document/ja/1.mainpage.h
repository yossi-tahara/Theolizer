...
|方式|特徴|
|----|----|
|アップデート|1.変更が手軽です。<br>2.自動生成するソース・コードが増えないためコンパイラへの負荷が軽いです。<br>3.古いデータを新しいプログラムで回復できますが、逆はサポートしていません。|
|バージョン・アップ|1.変更作業は少し手間がかかります。<br>2.旧バージョンの変数リストやシンボル・リストを保持するため、<br>自動生成されるソース・コードがバージョン番号を上げる度に増えます。<br>3.旧バージョン形式のデータを保存することができます。<br>4.その他アップデートよりもできることが多いです。|

それぞれの1, 2の特徴から、可能な時はアップデートにて変更対応し、それでは不足の場合にバージョン・アップすることがお薦めです。<br>
<br>
下記のような変更に対応しています。
...
例えば、変数にオフセットを追加した時、そのオフセットを加える処理などです。<br>
  - 旧バージョン形式で保存したい場合はバージョン・ダウン処理を定義することもできます。<br>
...
<b>バージョン・アップ／ダウンにおける不可逆性に注意</b><br>
