...
<div style="padding: 10px; margin-bottom: 10px; border: 1px solid #333333; border-radius: 10px; background-color: #d0d0d0;">
<b>注意事項：</b><br>
enum型はバージョン・アップ無しでのシンボル名／値変更に対応していましたが、クラスで変数名を変更する時はバージョン・アップが必要です。原理的には変更可能ですので要望があれば対応します。
</div>
...
<br>
//############################################################################
@section HowToModifyClass4 4.バージョン番号を変えてクラスに対して修正できる項目
//############################################################################
...
<br>
  - メンバ変数名の変更<br>
型を変更せず名前だけの変更であれば参照できますので、変更可能です。THEOLIZER_ANNOTATE()で指定します。<br><br>
  - クラス名の変更<br>
...
<br>
@subsection HowToModifyClass55 5-5.バージョン・アップ／ダウン処理のSucceedフラグ
...
<br>
@subsection HowToModifyClass61 6-1.バージョン番号変更無しの場合

<br>
@subsection HowToModifyClass62 6-2.バージョン番号変更有りの場合
