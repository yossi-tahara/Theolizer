...
<b>スマート・ポインタの保存と回復処理（source/reference_and_test/version/ver1/test_support_stl.cpp）</b><br>
unique_ptr、shared_ptr、weak_ptrの保存／回復のサンプル・ソースです。

@snippet  test_support_stl.cpp SmartPtr
...
<b>サンプル・ソース（source/reference_and_test/version/ver1/test_support_stl.cpp）</b><br>

@snippet  test_support_stl.cpp ContaierNomal

@subsection HowToUseContainer22 2-2.標準コンテナの要素を被ポインタとする保存／回復するサンプル・ソース

<b>サンプル・ソース（source/reference_and_test/version/ver1/test_support_stl.cpp）</b><br>

@snippet  test_support_stl.cpp ContaierPointee

@subsection HowToUseContainer23 2-3.標準コンテナの要素を合成回復サンプル・ソース

<b>サンプル・ソースsource/reference_and_test/version/ver1/test_support_stl.cpp）</b><br>

@snippet  test_support_stl.cpp ContaierDestinations


<br>
//############################################################################
@section TestContainer 3.スマート・ポインタと標準コンテナ網羅的な使用例（自動テスト）の説明
//############################################################################
...
<b>source/reference_and_test/version/ver1/test_support_stl.cpp</b>でテスト関数を定義してます。<br>
