...
set(VALGRIND_PARAM "")
if(UNIX)
    execute_process(COMMAND whereis -b valgrind OUTPUT_VARIABLE WHEREIS_VALGRIND RESULT_VARIABLE RETUEN_CODE)
    string(REPLACE "\n" "" WHEREIS_VALGRIND "${WHEREIS_VALGRIND}")
    message(STATUS "WHEREIS_VALGRIND=${WHEREIS_VALGRIND}")
    message(STATUS "RETUEN_CODE   =${RETUEN_CODE}")
    string(REPLACE "valgrind:" "" WHEREIS_VALGRIND "${WHEREIS_VALGRIND}")
    string(FIND "${WHEREIS_VALGRIND}" "valgrind" RESULT)
